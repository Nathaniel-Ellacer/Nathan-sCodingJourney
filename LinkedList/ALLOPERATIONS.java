...
public class ALLOPERATIONS {
    ...
    public static ALLOPERATIONS insert(ALLOPERATIONS list,
                                    int data)
    {
    ...
    public static void printList(ALLOPERATIONS list)
    {
    ...
    public static ALLOPERATIONS deleteByKey(ALLOPERATIONS list,
                                         int key)
    {
        // Store head node
    ...
    deleteAtPosition(ALLOPERATIONS list, int index)
    {
        // Store head node
        Node currNode = list.head, prev = null;
